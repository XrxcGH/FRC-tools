...
| `packages/ledger` | Polite ingestion from the FRC data layer, and signed offline venue packs |
...
**Status: 165 tests passing, ~5,800 lines of source.**
...
*Not implemented* — the BLE transport (the protocol is transport-agnostic and driven through an in-memory link in tests and the demo), Season Pack signing and distribution, and Ledger's actual ingestion jobs and bulk export.
