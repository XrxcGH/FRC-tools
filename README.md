...
**Status: 182 tests passing, ~6,000 lines of source.**
...
*Not implemented* — the native BLE shim (advertise/scan, MTU report, packet in/out — everything above it is built and tested against a simulated radio), Season Pack signing and distribution, and Ledger's actual ingestion jobs and bulk export.
