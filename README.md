...
**Status: 195 tests passing, ~6,300 lines of source.**
...
*Not implemented* — the native BLE shim (advertise/scan, MTU report, packet in/out — everything above it is built and tested against a simulated radio), and Ledger's actual ingestion jobs and bulk export.
