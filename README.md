...
**Status: 221 tests passing, ~6,900 lines of source (plus 3,800 lines of tests).**
...
*Not implemented* — the native BLE shim (advertise/scan, MTU report, packet in/out — everything above it is built and tested against a simulated radio), and Ledger's bulk export.
