...
**Status: 206 tests passing, ~6,500 lines of source (plus 3,400 lines of tests).**
...
*Not implemented* — the native BLE shim (advertise/scan, MTU report, packet in/out — everything above it is built and tested against a simulated radio), Ledger's bulk export, and the FIRST Events API adapter (The Blue Alliance's is built).
